...
var MODULE_PREFIX = 'linagora.esn.';
...
var awesomeWsServer = new AwesomeModule(MODULE_PREFIX + 'wsserver', {
  dependencies: [
    ...
    new Dependency(Dependency.TYPE_ABILITY, 'webserver', 'webserver', true),
  ...
  states: {
    lib: function(dependencies, callback) {
      ...
      var api = {
        server: getWSServer(logger, webserver),
 ...
 * @type {AwesomeModule}
 */
module.exports = awesomeWsServer;
